...
exports.updateMovie = async (req, res) => {
  ...
  // if (!req.file) return sendError(res, "L'affiche du film est manquante !");
  ...
  if (file) {
    // suppression de l'affiche du cloud s'il y en a une.
...
exports.removeMovie = async (req, res) => {
 ...
 // vérifie s'il y a une affiche ou non.
  // Si oui, nous devons supprimer cela.
