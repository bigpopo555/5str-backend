...
// mettre à jour
// Éléments à prendre en compte lors de la mise à jour.
// No.1 - est le fichier image / l'avatar est également mis à jour.
// No.2 - si oui, supprimez l'ancienne image avant de télécharger une nouvelle image / avatar.
...
exports.updateActor = async (req, res) => {
  ...
  // téléchargez un nouvel avatar s'il y en a un !
  if (file) {
    const { url, public_id } = await uploadImageToCloud(file.path);
